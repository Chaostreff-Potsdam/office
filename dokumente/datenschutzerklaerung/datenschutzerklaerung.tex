...
\markboth{Datenschutzerklärung des Vereins \emph{Chaos Computer Club Potsdam} e.~V. (CCCP)}{Datenschutzerklärung des Vereins \emph{Chaos Computer Club Potsdam} e.~V. (CCCP)}
