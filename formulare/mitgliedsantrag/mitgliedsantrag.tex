...
\begin{minipage}[c]{0.5\linewidth - 2.5mm}%
	...
	\checkbox{Kind unter 16 Jahren {\footnotesize (2,56~€ pro Monat)}}%
\end{minipage}%
\hspace*{5mm}%
\begin{minipage}[c]{0.5\linewidth - 2.5mm}%
	\begin{textinput}{\linewidth}%
...
Hiermit trete ich dem \emph{Chaos Computer Club Potsdam} e.~V. (CCCP) als Mitglied bei.
Ich habe die beigefügte Datenschutzerklärung zur Kenntnis genommen und stimme dieser zu.\strut
